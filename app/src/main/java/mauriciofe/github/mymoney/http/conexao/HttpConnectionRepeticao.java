...
public class HttpConnectionRepeticao {
    public static String postDados(String uri, String token, Repeticao repeticao) {
        String params = ParseRepeticao.convertForJson(repeticao);
